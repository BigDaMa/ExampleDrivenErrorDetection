...
setup(
    ...
    install_requires=['setuptools>=36','urllib3==1.26.5', 'matplotlib', 'numpy', 'pandas', 'sklearn', 'xgboost', 'seaborn', 'graphviz', 'jinja2', 'scipy', 'eli5', 'psycopg2', 'keras', 'tensorflow', 'usaddress', 'gensim'],
