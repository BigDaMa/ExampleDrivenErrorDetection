...
import operator
import pickle
from ml.simulate.MaxStdUncertainty.maxstddevuncertainty import select_by_max_stddev_certainty_all
from ml.simulate.MaxStdUncertainty.maxstddevuncertainty import get_all_certainty_stddev
...
for d in range(10):
    ...
    best_sum_total_f[d], best_col_seq[d] = select_by_max_stddev_certainty_all(tensor_run, np.ones(n, dtype=int), total_f, col_seq, matrix_batch_certainty_sum, future_steps, True) #Flight = 9, Blackoak 7, Hospital=5
