...
import operator
import pickle
from ml.simulate.MaxUncertaintyBatch.maxuncertaintybatch import select_by_max_uncertainty_batch
from ml.simulate.MaxUncertaintyBatch.maxuncertaintybatch import get_batch_certainty_sum
...
for d in range(10):
    ...
    certainty_sum = get_batch_certainty_sum(x, feature_names)
    ...
    best_sum_total_f[d], best_col_seq[d] = select_by_max_uncertainty_batch(tensor_run, np.ones(n, dtype=int), total_f, col_seq, matrix_batch_certainty_sum, future_steps, True) #Flight = 9, Blackoak 7, Hospital=5
