...
import operator
import pickle
from ml.simulate.Random.random import select_by_random
...
for d in range(10):
    ...
    for rand_t in range(10):
        best_sum_total_f[inner_d], best_col_seq[inner_d] = select_by_random(tensor_run, np.ones(n, dtype=int) * -1, [], [], future_steps, True) #Flight = 9, Blackoak 7, Hospital=5
        inner_d += 1
        #print list(best_sum_total_f[inner_d-1])
print best_col_seq
