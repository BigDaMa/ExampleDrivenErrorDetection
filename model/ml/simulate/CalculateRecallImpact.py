...
from ml.simulate.PredictRecall.predictRecall import select_by_estimated_max_recall_impact
...
future_steps = 60 #BlackOak = 7, Flights = 9, Hospital=60
...
for d in range(10):
    ...
    best_sum_total_f[d], best_col_seq[d] = select_by_estimated_max_recall_impact(tensor_run, np.ones(n, dtype=int), total_f, col_seq, estimated_scores, future_steps, True) #Flight = 9, Blackoak 7, Hospital=5
