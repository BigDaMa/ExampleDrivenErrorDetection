...
for a in range(10):
    for b in range(10):
        for d in range(10):
            ...
            certainty_sum_a = get_all_certainty_sum(x_a, feature_names)
            ...
            certainty_sum_b = get_all_certainty_sum(x_b, feature_names)
            ...
            for run in range(runs):
                    ...
                    matrix_batch_certainty_sum[0, run] = certainty_sum_a[run * 1 + 0]

                    matrix_batch_certainty_sum[1, run] = certainty_sum_b[run * 1 + 0]
            ...
            best_sum_total_f[d], best_col_seq[d] = select_by_max_uncertainty_all(new_tensor_run,
                                                                                 np.ones(new_n, dtype=int), total_f,
                                                                                 col_seq,
                                                                                 matrix_batch_certainty_sum,
                                                                                 future_steps,
