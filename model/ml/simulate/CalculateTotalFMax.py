...
for d in range(10):
    ...
    if check_for_convergence:
        ...
        best_sum_total_f[d], best_col_seq[d] = find_max_total_f_new(tensor_run, np.ones(n, dtype=int), total_f, col_seq, future_steps, done, True) #Flight = 9, Blackoak 7, Hospital=5
    else:
        best_sum_total_f[d], best_col_seq[d] = find_max_total_f(tensor_run, np.ones(n, dtype=int), total_f, col_seq,
                                                                    future_steps,
