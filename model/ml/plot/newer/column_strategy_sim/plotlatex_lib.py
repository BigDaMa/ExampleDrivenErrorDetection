...
def calc_integral(ranges, list_series, list_names, x_max=None, x_min=None, sorted=True, normalize=True):
	...
	for i in range(len(list_names)):
		for iteration in range(len(list_series[i])):
			...
			if ranges[i][iteration] > x_min and ranges[i][iteration] < x_max:
				if iteration == 0:
...
def plot_integral(ranges, list_series, list_names, title, x_max=None, x_min=None, relative=True, sorted=True):
	list_names, integral = calc_integral(ranges, list_series, list_names, x_max, x_min, sorted=True)
...
def get_end(ranges, list_series, list_names, x_max=None, x_min=None, sorted=True, normalize=True):
	integral = np.zeros(len(list_names))

	for i in range(len(list_names)):
		integral[i] += list_series[i][-1]

	integral /= float(len(list_series))
...
def plot_end(ranges, list_series, list_names, title, x_max=None, x_min=None, relative=True, sorted=True):
	list_names, integral = get_end(ranges, list_series, list_names, x_max, x_min, sorted=True)
