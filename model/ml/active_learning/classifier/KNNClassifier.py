...
class KNNClassifier(object):
    ...
    def run_cross_validation(self, train, train_target, folds, column_id):
        ...
        cv_params = {'n_neighbors': neighbors}
        ind_params = { }

        optimized_GBM = GridSearchCV(KNeighborsClassifier(**ind_params),
                                     cv_params,
    ...
    def train_predict(self, x, y, column_id):
        ...
        self.model[column_id] = KNeighborsClassifier(**param)
    ...
    def run_cross_validation_eval(self, train, train_target, folds, column_id):
        scores = cross_val_score(KNeighborsClassifier(**self.params[column_id]), self.scaler.transform(train), train_target, cv=folds, scoring='f1')
        return scores