...
class LogisticRegressionClassifier(object):
    ...
    def run_cross_validation(self, train, train_target, folds, column_id):
        ...
        optimized_GBM = GridSearchCV(LogisticRegression(**ind_params),
                                     cv_params,
    ...
    def train_predict(self, x, y, column_id):
        ...
        self.model[column_id] = LogisticRegression(**param)
    ...
    def run_cross_validation_eval(self, train, train_target, folds, column_id):
        scores = cross_val_score(LogisticRegression(**self.params[column_id]), self.scaler.transform(train), train_target, cv=folds, scoring='f1')
        return scores